...
docker run --name ${CONTAINER_NAME} -t -v "${REPO_DIR}":/test-api-source-repo:ro cytopia/yamllint -s -c /test-api-source-repo/.yamllintconfig.yaml /test-api-source-repo
